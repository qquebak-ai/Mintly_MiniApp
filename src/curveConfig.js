...
export const CURVE_PARAMS = {
  ...
  // Комиссии площадки нет: ноль с покупки и ноль с продажи. Была один
  // процент — деньги небольшие, но на входе и выходе они съедали как раз
  // ту разницу, ради которой мемкоин и покупают. У токенов, запущенных
  // при прежней настройке, она останется: параметры зашиты в контракт
  // навсегда, и предпросчёт берёт feeBps из состояния конкретной кривой,
  // а не отсюда.
  feeBps: 0n,
};
